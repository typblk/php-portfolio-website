                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        <?php foreach ($hizmetler->getHizmet() as $item) : ?>
                            <tr>
                                <td><span class="fw-medium"><?php echo $item->hizmet ?></span></td>
                                <td><img src="../images/<?php echo $item->fotograf ?>" width="80" alt="" class="img-fluid"></td>
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="hizmet-duzenle.php?id=<?php echo $item->id ?>"><i class="bx bx-edit-alt me-1"></i> Düzenle</a>
                                            <button class="dropdown-item Ssil" data-id="<?php echo $item->id ?>" data-add="<?php echo $item->hizmet ?>" data-bs-toggle="modal" data-bs-target="#modalHsil"><i class="bx bx-trash me-1"></i> Sil</button>
                                        </div>
                                    </div>
                                </td>
                            </tr>
