...
if (isset($_POST["submit"])) {
    ...
    $uploadDir = '../images/';
    $allowedTypes = ['image/jpeg', 'image/png', 'image/gif', 'image/jpg', 'image/webp', 'image/svg+xml'];
    ...
    if (!empty($errors)) {
        ...
        if ($hakkimda->editHakkimizda($baslik, $fotografNewName, $hakkimizda)) {
            echo '
            ...
            <div class="bs-toast toast fade show bg-danger" role="alert" aria-live="assertive" aria-atomic="true">
                ...
                <div class="toast-body">
                    Hakkımızda güncellenirken bir hata oluştu.
                </div>
            </div>';
        }
    }
...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Dashboard /</span> Hakkımızda
        </h4>
        <div class="card mb-4">
            <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" name="fotograf" id="proje-foto">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="hakkimizda">Hakkımda</label>
                        <textarea id="hakkimizda" class="form-control" rows="10" name="hakkimizda"><?php echo htmlspecialchars($item->hakkimizda) ?></textarea>
                    </div>
